...
const useMouseParallax = (...depths) => {
    ...
    }, [depths]); // eslint-disable-line react-hooks/exhaustive-deps
        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{
                    ...
                    You can <Link to="/" className="canyon-link">{homeText}</Link>, or <span style={{ cursor: 'pointer' }} className="canyon-link">{searchText}</span>.
                </p>
            </div>
